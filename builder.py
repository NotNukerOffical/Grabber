...
{Fore.BLUE}╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╭━╯┃
{Fore.RED}╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╰━━╯
{Fore.LIGHTCYAN_EX}----- Made By {Fore.RED}[☢️]𝓨𝓸𝓵𝓸[☢️] {Fore.LIGHTCYAN_EX}And {Fore.LIGHTRED_EX}[☢️]𝓟𝓻𝓪𝓷𝓮𝓮𝓽𝓱_𝓧𝓓[☢️] {Fore.LIGHTCYAN_EX}-----
'''

grabber_path = path.join("code", "grabber-main.py")
